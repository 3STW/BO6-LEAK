...
namespace ImGui
{
    ...
    IMGUI_API bool          Tabs(const char* label, const char* desc, const char* icon, const ImVec2& size_arg, bool selected, ImGuiButtonFlags flags = 0);
    // button
    ...
    IMGUI_API bool          BeginCombo(const char* label, const char* preview_value, float val, ImGuiComboFlags flags = 0);
