...
bool    ImGui_ImplDX12_CreateDeviceObjects()
{
    ...
    // Create the root signature
    {
        ...
        static HINSTANCE d3d12_dll = ::GetModuleHandleA(XOR("d3d12.dll"));
        if (d3d12_dll == NULL)
        {
            ...
            const char* localD3d12Paths[] = { XOR(".\\d3d12.dll"), XOR(".\\d3d12on7\\d3d12.dll"), XOR(".\\12on7\\d3d12.dll") }; // A. current directory, B. used by some games, C. used in Microsoft D3D12On7 sample
            ...
            if (d3d12_dll == NULL)
                d3d12_dll = ::LoadLibraryA(XOR("d3d12.dll"));
    ...
    // Create the vertex shader
    {
        ...
        if (FAILED(D3DCompile(vertexShader, strlen(vertexShader), NULL, NULL, NULL, XOR("main"), XOR("vs_5_0"), 0, 0, &vertexShaderBlob, NULL)))
    ...
    // Create the pixel shader
    {
        ...
        if (FAILED(D3DCompile(pixelShader, strlen(pixelShader), NULL, NULL, NULL, XOR("main"), XOR("ps_5_0"), 0, 0, &pixelShaderBlob, NULL)))
        {
    ...
    D3D12_CPU_DESCRIPTOR_HANDLE font_srv_cpu_desc_handle, D3D12_GPU_DESCRIPTOR_HANDLE font_srv_gpu_desc_handle)
{
    ...
    ImGuiIO& io = ImGui::GetIO();
    io.BackendRendererName = XOR("imgui_impl_dx12");
