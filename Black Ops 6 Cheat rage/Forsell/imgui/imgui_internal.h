...
inline ImColor main_color = { ImColor(255, 0, 0, 255) };
...
struct ImGuiContext
{
    ...
    ImGuiID                 NavActivateInputId;   // ~~ (g.ActiveId == 0) && (IsKeyPressed(ImGuiKey_Space) || IsKeyDown(ImGuiKey_Enter) || IsKeyPressed(ImGuiKey_NavGamepadActivate)) ? NavId : 0, also set when calling ActivateItem()
...
namespace ImGui
{
    ...
    IMGUI_API bool          Tabss(const char* label, bool selected, const ImVec2& size_arg, ImGuiButtonFlags flags);
    IMGUI_API bool          TabButton(const char* label, const char* icon, const ImVec2& size_arg, bool selected, bool bugfix);
    IMGUI_API bool          TabButtonEx(const char* label, const char* icon, const ImVec2& size_arg, ImGuiButtonFlags flags, bool selected, bool bugfix);
    ...
    IMGUI_API bool          Tabs(bool selected, const char* ico, const char* label, const ImVec2& size_arg, ImGuiButtonFlags flags = 0);
