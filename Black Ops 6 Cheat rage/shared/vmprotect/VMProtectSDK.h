...
#ifdef _DEBUG
#define VMPROTECT_BEGIN_VIRTUALIZE
#define VMPROTECT_BEGIN_MUTATE
#define VMPROTECT_BEGIN_ULTRA
#define VMPROTECT_END
#else
#define VMPROTECT_BEGIN_VIRTUALIZE VMProtectBeginVirtualization( __FUNCTION__ );
#define VMPROTECT_BEGIN_MUTATE VMProtectBeginMutation( __FUNCTION__ );
#define VMPROTECT_BEGIN_ULTRA VMProtectBeginUltra( __FUNCTION__ );
