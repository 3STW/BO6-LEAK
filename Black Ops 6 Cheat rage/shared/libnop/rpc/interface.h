...
#include "../traits/function_traits.h"
#include "../types/variant.h"
#include "../utility/sip_hash.h"
...
#define NOP_METHOD(name, ... /* signature */)                                  \
  NOP_METHOD_SEL(::nop::ComputeMethodSelector"../__INTERFACE::MethodSelector>( \
...
#define NOP_METHOD_SEL(selector, name, ... /* signature */)           \
  using name = ::nop::InterfaceMethod"../__INTERFACE::MethodSelector, \
